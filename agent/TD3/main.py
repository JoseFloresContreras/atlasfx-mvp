...
if __name__ == "__main__":
	...
	eval_env = ForexTradingEnv(
        data_path="../../data-pipeline/data/1H_forex_data_val.parquet",
        episode_length=100,
        initial_balance=1,
        transaction_fee=0.0001,
        max_position_size=0.1,
	...
	evaluations = [[eval_policy(policy, train_env, args.seed), eval_policy(policy, eval_env, args.seed)]]
	...
	for t in range(int(args.max_timesteps)):
		...
		if (t + 1) % args.eval_freq == 0:
			evaluations.append([eval_policy(policy, train_env, args.seed), eval_policy(policy, eval_env, args.seed)])
